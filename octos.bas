...
90 FG=0:IFC(I,4)<=0THENC(I,4)=0:PRINT@876+2*I," ";:PRINT@940+2*I
...
120 NX=PX:NY=PY:ONMVGOTO120,140,150,160,,170,180,190,200
...
300 FG=0:IFBD(NX,NY)>2 AND BD(NX,NY)=BD(PX,PY)THENFG=-1:RETURNELSERETURN
...
430 IFC(J1)=NXANDC(J,2)=NYTHEN310
...
1090 BD(X,Y)=6:BD(X+1,Y+1)=5:BD(X+1,Y)=4:BD(X,Y+1)=4:RETURN
1100 FORX=6TO8:BD(X,5)=2:BD(X,9)=2:NEXTX
1110 FORY=6TO8:FORX=5TO9:BD(X,Y)=2:NEXTX,Y
1120 BD(7,6)=-1:BD(6,7)=-1:BD(7,7)=-:BD(8,7)=-1:BD(7,8)=-1
...
1280 Y=14:FORX=2TO24 STEP2:SET(X,Y):SET(X+1,Y):SET(84-X,Y):SET(85-X,Y):Y=Y-1:NEXT
1290 Y=30:FORX=2TO24 STEP2:SET(X,Y):SET(X+1,Y):SET(84-X,Y):SET(85-X,Y):Y=Y+1:NEXT
1300 READX,Y:IFX=0THEN1320ELSEFORI=XTOYSTEP3:PRINT@I,".";:NEXTI:GOTO1300
1310 DATA 79,91,140,158,201,225,262,292,323,359,387,402,408,423,451,463,475,487,515,530,536,551,579,615,646,676,713,737,780,798,847,859,0,0
...
1370 FORI=1TONC:PRINT@(64*C(I,2)+3*C(I,1)-1),I;:PRINT@876+2*1,"N";:PRINT@940+2*I,"8";:NEXTI
...
2250 IFDS<>1THEN2310
2260 IFLF>1THEN2280
2270 IFSBTHENSB=0:GOTO2380ELSE2350
2280 IFWKTHEN2300
2290 IFSBTHENSB=0GOTO2360ELSE2350
...
2610 PRINT@64*HY+3*HX,".";:PRINT@938,HS;:FORN=1TO4:FORJ=1TO25:PRINT@468,F$(J);:NEXTJ,N:GOTO6000
...
3075 IFA$="U"THENA$="7":GOTO3190 ELSEIFA$="I"THENA$="8":GOTO3190 ELSEIFA$="D"THENA$="9":GOTO3190 ELSEIFA$="J"THENA$="4":GOTO3190
3076 IFA$="L"THENA$="6":GOTO3190 ELSEIFA$="M"THENA$="1":GOTO3190 ELSEIFA$=","THENA$="2":GOTO3190 ELSEIFA$="."THENA$="3":GOTO3190
...
3160 IFC(I,5)=0ORRND(10)<C(I,3)THENM$=M$+" AND HIT":GOSUB230:C(I,4)=C(I,4)-1:HT=0:GOSUB250:HT=-1:GOSUB90:IFFGTHENC(I,0)=0:GOSUB100:PRINT@64*C(I,2)+3*C(I,1),".";:GOTO3030:ELSE3030
...
3270 M$=M$+" AND TRIPS":GOSUB220:GOSUB230:HL=HL+1:IFHL>HMTHEN2000ELSEGG=64*HY+3*HX:PRINT@GG,CHR$(95);:M$="GETTING UP":GOSUB230:FORK=1TO3:FORM=1TO25:PRINT@468,F$(M);:NEXTM,K:PRINT@GG,"H";:GOTO3030
...
3320 IFC(J,1)=NXANDC(J,2)=NYTHENC(I,3)=C(I,3)+4:GOSUB230:IFC(I,3)>9THENNC(I,3)=9:GOTO3030ELSE3030
...
3350 PRINT@(54*NY+3*NX),RIGHT$(STR$(I),1);:C(I,1)=NX:C(I,2)=NY:GOSUB300
...
4010 CLS:PRINT@325,"CONGRATULATIONS! YOU HAVE SUCCEEDED IN FIGHTING"NC"OCTON
WARRIOR"G$".":PRINT
...
4090 PRINT"YOU HAVE COMPLETED THE"STR$(NC);:G$" CONTEST IN THE OCTON CHALLENGE.
YOU MAY REST IF YOU WISH, THEN PRESS ANY KEY TO CONTINUE."
4100 A$=INKEY$:IFA$=""THEN4100ELSENC=NC+1:RESTORE:TOTO1200
...
5010 PRINT"
        YOUR STAR CRUISER HAS BEEN CAPTURED WHILE TRAVELING
THROUGH SPACE CLAIMED BY THE OCTON DYNASTY.  AFTER SOME
DELIBERATION, THE COUNCIL OF EIGHT HAS GRANTED YOU THE CHANCE
TO EARN YOUR FREEDOM BY ACCEPTING THE 'OCTON CHALLENGE'."
5020 PRINT"
        YOU WILL BE PLACED IN AN ARENA, WITH A SWORD AND A
SHIELD.  YOU WILL THEN ENGAGE ONE OCTON IN COMBAT.  IF YOU
SURVIVE, YOU WILL THEN FIGHT TWO, THEN THREE.... UNTIL THERE
ARE EIGHT OCTONS IN THE ARENA."
5030 PRINT"
        THE OCTONS HAVE EIGHT MOVES, AND A 'STRENGTH' FACTOR
OF EIGHT.  THIS MEANS THAT AN OCTON CAN RECEIVE EIGHT DIRECT
BLOWS BEFORE HE IS REMOVED FROM THE ARENA."
5040 PRINT@876, "PRESS <ENTER> TO CONTINUE";
5050 A$INKEY$:IFA$=""THEN5050
5060 CLS:PRINT"
        THE ARENA OF OCTOS IS AN EIGHT-SIDED STRUCTURE. THERE
ARE EIGHT STONES PLACE INT HE ARENA, TO TRIP THE CONTESTANTS.
IN THE CENTER OF THE ARENA IS ANOTHER HAZARD, THE FIRE PIT."
5070 PRINT"
        THE COUNCIL OF EIGHT HAS DETERMINED THAT HUMANS ARE
TO BE ALLOWED TEN MOVES, AND TEN STRENGTH POINTS SINCE HUMANS
ARE DECIMAL CREATURES."
5080 PRINT"
        IF YOU CROSS A STONE DURING THE CONTEST, YOU HAVE A
50% CHANCE OF TRIPPING AND LOSING A TURN.  IF YOU ENTER THE
FIREPIT, YOU WILL LOSE ONE STRENGTH POINT, AND YOU WILL LOWER
...
5120 FORX=98TO106STEP2:SET(X,Y):SET(X+1,Y):SET(X+16,Y+6):SET(X+17,Y+6):Y=Y+1:NEXT
5130 Y=12:FORX=98TO106STEP2:SET(X,Y):SET(X+1,Y):SET(X+16,Y-6):SET(X+17,Y-6):Y=Y-1:NEXT
5140 PRINT@0,"        YOU MOVE INT HE AARENA BY";:PRINT@64,"PRESSING KEYS 1-9 OR THE LETTER KEYS";:PRINT@128,"INDICATED BY THE CHART, TO MOVE IN";
...
5170 PRINT"
        IF AN OCTON HAS HIS SHIELD RAISED, YOUR FIRST SWING HAS
A 10% CHANCE OF CONNECTING.  THE SECOND SWING HAS A 50% CHANCE,
AND AFTER THAT THERE IS A 90% CHANCE OF A HIT."
5180 PRINT@976,"PRESS <ENTER> TO CONTINUE";
5190 A$=INKEY$:IFA$=""THEN5190
5200 CLS:PRINT@256,"
        THE COUNCIL OF EIGHT HAS GRANTED YOU A 'PRACTICE'
SESSION, TO FAMILIARIZE YOU WITH THE ARENA.":PRINT:GOTO1160
5201 ' Human has lost
6000 G$="":IFNC>1THENG$="S"
6010 CLS:PRINT@325,"YOU HAVE LOST IN YOUR BATTLE AGAINST"NC"OCTON WARRIOR"G$".":IFDDTHENPRINT"
YOU WILL NOW REMAIN AN OCTON SLAVE, AND BE FORCED TO WORK AT
THE OCTAL PALACE FOR SCRAPS OF FOOD.":PRINT"
YOU WILL HAVE TO TRY AGAIN WHEN YOU THINK YOU ARE  ":END
6020 PRINT"
